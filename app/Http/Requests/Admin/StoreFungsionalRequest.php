...
class StoreFungsionalRequest extends FormRequest
{
    /**
    ...
    {
        // Assuming 'manage_datamaster' permission is used, similar to StoreUnitRequest
    ...
    public function rules(): array
    {
        return [
            ...
            'kode' => ['required', 'string', 'max:255', Rule::unique('fungsionals', 'kode')],
